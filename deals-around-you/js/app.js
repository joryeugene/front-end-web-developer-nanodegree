function appViewModel() {
  ...
  this.searchLocation = ko.observable('Minneapolis / St Paul');
  ...
  this.currentLat = ko.observable(44.9778);
  this.currentLng = ko.observable(-93.2650);
...
// Initialize Google map, perform initial deal search on a city.
  function mapInitialize() {
    city = new google.maps.LatLng(44.9778, -93.2650);
    ...
    getGroupons('minneapolis-stpaul');
    getGrouponLocations();
  }
